...
# Add purem/ to path so local datapipe and purem_zarr_reader resolve
...
class Trainer:
    """Trainer for Purem crash surrogate models (identical logic to crash/train.py)."""
